...
This toolbox extracts various features from facial tracked sleap videos.  The /src/fefe folder contains functions for extracting specific types of features.  
